...
public class HttpClient {
	...
	public void login(String username, String password) throws IOException, FanfouException {
	...
	public InputStream post(String url, ArrayList<NameValuePair> params) 
			throws FanfouException, IOException {
    ...
    public InputStream httpRequest(String url, ArrayList<NameValuePair> postParams,
		...
		try {
			...
			throw new FanfouException("Invalid URL.");
		}
