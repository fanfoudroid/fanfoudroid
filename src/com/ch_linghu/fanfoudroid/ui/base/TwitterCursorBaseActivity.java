...
import com.hlidskialf.android.hardware.ShakeEventListener;
...
public abstract class TwitterCursorBaseActivity extends TwitterListBaseActivity {
	...
	// 晃动刷新 (onResume onStop有两句关于传感器控制的语句）
	...
	{
		useShake = TwitterApplication.mPref.getBoolean(Preferences.USE_SHAKE,
				false);
		if (useShake) {
