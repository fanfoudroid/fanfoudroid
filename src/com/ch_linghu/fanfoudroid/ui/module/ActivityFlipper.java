...
public class ActivityFlipper implements Widget, IFlipper {
	...
	public void launchActivity(Class<?> cls) {
		...
		if (mActivities.indexOf(cls) == 0) {
			myView.setImageResource(R.drawable.point_left);
		} else if (mActivities.indexOf(cls) == 1) {
			myView.setImageResource(R.drawable.point_center);
		} else if (mActivities.indexOf(cls) == 2) {
		...
		if (mActivities.indexOf(cls) == 0 || mActivities.indexOf(cls) == 1
				|| mActivities.indexOf(cls) == 2) {
			myToast.show();
		}
	}
